...
const FAQList: FAQProps[] = [
  
  {
    ...
    answer: "Je propose des solutions sur mesure pour répondre à vos besoins numériques : <ul>"+
  ...
  },
  {
    ...
    answer: "Oui ! Nous travaillons avec des entreprises de toutes tailles, des start-ups aux grandes organisations.",
    value: "item-2",
  },
  {
    question: "Travaillez-vous uniquement avec des entreprises ou aussi avec des particuliers ?",
    answer: "Je travaille principalement avec des entreprises (TPE, PME, start-ups, grandes organisations), mais je peux également collaborer avec des particuliers ayant des projets numériques concrets.",
    value: "item-3",
  },
  {
    question: "Quels sont vos délais de réalisation ?",
    answer: "Les délais dépendent de la complexité de votre projet. Par exemple : <ul>" +
  ...
  },
  {
    ...
    answer: "Oui, une garantie de suivi est incluse après la livraison pour résoudre les éventuels bugs ou ajustements nécessaires. La durée de cette garantie dépend du type de projet.",
    value: "item-5",
  },
  {
    question: "Quels outils et technologies utilisez-vous ?",
    answer: "Je maîtrise les technologies modernes pour garantir des solutions performantes :<ul>" +
